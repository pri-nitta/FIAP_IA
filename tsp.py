...
# individuo zero, pois tem o melhor valor de fitness
    best_fitness = calculate_fitness(population[0])
    #de fato o individio que faz o melhor valor.
...
#desenhar a cidade
    ...
    #segundo melhor individuo
    draw_paths(screen, population[1], rgb_color=(128, 128, 128), width=1)

#ver no console a geração que está e o fitness
    print(f"Generation {generation}: Best fitness = {round(best_fitness, 2)}")

#inicia a nova população com o melhor individuo
#maneira de preservar o melhor individuo e não perder a melhor solução
#aumentamos o aproveitamento da solução e diminui a exploração
    ...
    while len(new_population) < POPULATION_SIZE:
        ...
        #probabilidade eh um sob o fitness, quanto menor a distancia da trajetoria do individuo, maior a probabilidade de escolha
        probability = 1 / np.array(population_fitness)
        #passa população atual, quero que sorteie 2 de maneira que a probabilidade é o inverso da distancia
        #pode usar o torneio, seleciona 2 individuos aleatoriamente e o individuo que tiver a menor distancia, maior fitness, ai mantem, e vai pegando 2 aleatorios e vendo a distancia menor.
