...
#calcula a distancia com a somatoria não é o metodo mais eficiente, o melhor é a matriz de distancia
...
#chama a distancia mais o calculo da distancia, somando todas as distancias, quanto menor o fitness, melhor
...
def order_crossover(parent1: List[Tuple[float, float]], parent2: List[Tuple[float, float]]) -> List[Tuple[float, float]]:
    ...
    """
    #tamanho no numero de cidades
    length = len(parent1)

#sortear valores no ex foi 2 e 7
